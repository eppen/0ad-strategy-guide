...
- 维基：[0 A.D. Wiki](https://0ad.fandom.com/wiki/)
...
| 章节 | 内容 |
|------|------|
| [入门指南](01-getting-started.md) | 安装、界面、首局流程 |
| [核心机制](02-game-basics.md) | 资源、领土、公民兵、胜负条件 |
| [经济发展](03-economy.md) | 采集效率、贸易、阶段升级 |
| [军事战术](04-military.md) | 兵种克制、阵型、攻城与海战 |
| [三阶段进阶](05-phases.md) | 村落 → 城镇 → 城市 节奏 |
| [文明详解](06-civilizations.md) | 15 个文明特色与推荐打法 |
| [多人对战](07-multiplayer.md) | 联机、排位、常见套路 |
| [进阶技巧](08-advanced-tips.md) | 微操、反制、AI 与 Mod |
...
详见 [文明详解](06-civilizations.md)。

## 贡献

欢迎 Issue / PR：修正数据、补充文明打法、翻译改进。

本攻略采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 授权。游戏本体代码为 GPL v2，美术为 CC BY-SA 3.0——请遵守 Wildfire Games 的商标与素材使用规范。
